...
public class PayrollTester {
	...
	public static void main(String[] args) {
		try {
			SalariedEmployee s1 = new SalariedEmployee("Joe", "Francis", "046454286", 2500);
			SalariedEmployee s2 = new SalariedEmployee("Samatha", "Hughes", "004327839", 1400);
			s2.setManager(s1);
			
			HourlyEmployee h = new HourlyEmployee("Kim", "Adams", "147621627", 42, 18.50);
			h.setManager(s1);
			
			CommissionEmployee c = new CommissionEmployee("Ryan", "Goodall", "391949971", 10, 9000);
			c.setManager(s2);
